...
llvm module lean_echo do
  ...
  define i32 @main(i32 %argc, i8** %argv) do
    ...
    call @l_IO_println___at_Lean_instEval___spec__1(%arg1s, inttoptr (i32 1 to %lean_object*))
    ret i32 0
...
llvm module lean_select do
  ...
  declare %lean_object* @l_IO_println___at_Lean_instEval___spec__1(%lean_object*, %lean_object*)
  define i32 @main(i32 %argc, i8** %argv) do
    let realW ← llvm inttoptr (i32 1 to %lean_object*)
    br1:
      %arg1p = getelementptr i8*, %argv, i32 1
      %arg1 = load i8*, %arg1p
      %arg1s = call @lean_mk_string(%arg1)
      call @l_IO_println___at_Lean_instEval___spec__1(%arg1s, realW)
      ret i32 0
    br2:
      %arg2p = getelementptr i8*, %argv, i32 2
      %arg2 = load i8*, %arg2p
      %arg2s = call @lean_mk_string(%arg2)
      call @l_IO_println___at_Lean_instEval___spec__1(%arg2s, realW)
      ret i32 0;
    %arg0 = load i8*, %argv
    %arg0c = load i1, %arg0
    br %arg0c, %br1, %br2
